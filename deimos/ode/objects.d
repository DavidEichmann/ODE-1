 ...
 */
int dWorldUseSharedWorkingMemory(dWorldID w, dWorldID from_world/*=NULL*/);
 ...
 * @see dWorldUseSharedWorkingMemory
 */
int dWorldSetStepMemoryReservationPolicy(dWorldID w, in dWorldStepReserveInfo* policyinfo/*=NULL*/);
...
* @see dWorldUseSharedWorkingMemory
*/
int dWorldSetStepMemoryManager(dWorldID w, in dWorldStepMemoryFunctionsInfo* memfuncs);
 ...
 * @ingroup bodies
 */
void dBodySetMass(dBodyID, in dMass* mass);
...
void dBodyAddForceAtPos(
    dBodyID, dReal fx, dReal fy, dReal fz, dReal px, dReal py, dReal pz
);
/**
 * @brief Add force at specified point in body in local coordinates.
 * @ingroup bodies
 */
void dBodyAddForceAtRelPos(
    dBodyID, dReal fx, dReal fy, dReal fz, dReal px, dReal py, dReal pz
);
/**
 * @brief Add force at specified point in body in global coordinates.
 ...
 * If it is nonzero the joint is allocated in the given joint group.
 */
dJointID dJointCreateContact(dWorldID, dJointGroupID, in dContact *);
...
void dJointSetHingeAnchorDelta(
    dJointID, dReal x, dReal y, dReal z, dReal ax, dReal ay, dReal az
);
 ...
 */
void dJointSetUniversalAxis1Offset(
    dJointID, dReal x, dReal y, dReal z, dReal offset1, dReal offset2
);
...
void dJointSetUniversalAxis2Offset(
    dJointID, dReal x, dReal y, dReal z, dReal offset1, dReal offset2
);
 ...
 */
void dJointSetPUAnchorOffset(
    dJointID, dReal x, dReal y, dReal z, dReal dx, dReal dy, dReal dz
);
 ...
 *           when body1 was at current_position[Z] - dz
 */
void dJointSetPistonAnchorOffset(
    dJointID j, dReal x, dReal y, dReal z, dReal dx, dReal dy, dReal dz
);
